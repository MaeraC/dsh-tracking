    ...
    const handleSearch = async () => {
        try {
            ...
            const filteredVisits = allVisits.filter(visit => {
                const matchesSalon = salonName ? visit.salonName === salonName : true
                ...
                <div className="search-results">
                    ...
                    {searchResults.map((visit, index) => {
                        if (visit.typeOfForm === "Feuille de route") {
                            ...
                            return (
                                <div className="saved-data" key={index}>
                            ...
                            return (
                               <ul className="fsp-results" key={index}>
                                 <li key={index}>
                            ...
                            return (
                                <li className="crd-saved" key={index}>
                                <p><span className="bold">{visit.typeOfForm} </span>n° {index +1}</p>
                                <p><strong>Nom du salon:</strong> {visit.salonName}</p>
                            ...
                            return (
                                <ul className="crd-results" key={index}>
                                    <li key={index}>
                                    <p><span className="bold">{visit.typeOfForm} </span>n° {index +1}</p>
                                    <p><strong>Nom du salon:</strong> {visit.salonName}</p>
                                    <p><strong>Ville:</strong> {visit.ville}</p>
